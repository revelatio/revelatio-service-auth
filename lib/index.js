...
var getKeysForUser = function getKeysForUser(github) {
  return github.users.getKeys({}).then(_ramda2.default.prop('data'));
};
...
var genkeys = function genkeys(req, res) {
  return (0, _helpers.generateKeypair)().then(function (keys) {
    return res.json(keys);
  });
};

var handler = exports.handler = (0, _microrouter.router)((0, _microrouter.get)('/login/callback', callback), (0, _microrouter.get)('/login', login), (0, _microrouter.get)('/login/keypair', genkeys), function (req, res) {
  return res.send('ok');
});